<%-- 
    Document   : BrandUpload
    Created on : Oct 17, 2024, 12:02:33 PM
    Author     : robin
--%>
...
//checking if request cotains multipart data
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("filephoto"))//write the name of image here it is img_product
                {
                    ...
                    String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\Staff\\";//path for storing image
                    Random r = new Random();//to generate random number
                    int r_num = r.nextInt(1111) + 999;//values between this are generated

                    photo = "Staff" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
    ...
    String InsQry = "INSERT INTO tbl_staff( staff_name, staff_contact,staff_doj, staff_address,staff_photo)"
            + "values('" + value[0] + "','" + value[1] + "',curdate(),'" + value[2] + "','" + photo + "')";
...
<script type="text/javascript">
    alert("Staff Added");
    setTimeout(function() {
        window.location.href = '../../Admin/Stafflist.jsp'
