                            ...
                            <div class="QA_section">
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int i = 0;
                                                String selQry = "select * from tbl_complaint c inner join tbl_customer co on co.customer_id=c.customer_id where complaint_status='0'";
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int j = 0;
                                                String selQry1 = "select * from tbl_complaint c inner join tbl_customer co on co.customer_id=c.customer_id where complaint_status='1'";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><%=rs1.getString("customer_name")%></td>
